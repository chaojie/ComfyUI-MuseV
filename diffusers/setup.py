...
8. Check that everything looks correct by uploading the package to the PyPI test server:
   ...
   python -c "from MuseVdiffusers import __version__; print(__version__)"
   python -c "from MuseVdiffusers import DiffusionPipeline; pipe = DiffusionPipeline.from_pretrained('fusing/unet-ldm-dummy-update'); pipe()"
   python -c "from MuseVdiffusers import DiffusionPipeline; pipe = DiffusionPipeline.from_pretrained('hf-internal-testing/tiny-stable-diffusion-pipe', safety_checker=None); pipe('ah suh du')"
   python -c "from MuseVdiffusers import *"
...
#
# python -c 'import sys; from MuseVdiffusers.dependency_versions_table import deps; \
...
#
# pip install -U $(python -c 'import sys; from MuseVdiffusers.dependency_versions_table import deps; \
# print(" ".join([deps[x] for x in sys.argv[1:]]))' tokenizers datasets)
#
