...
class CopyCheckTester(unittest.TestCase):
    ...
    def test_is_copy_consistent(self):
        ...
        self.check_copy_consistency(
            "# Copied from MuseVdiffusers.schedulers.scheduling_ddpm.DDPMSchedulerOutput",
            "DDPMSchedulerOutput",
            REFERENCE_CODE + "\n",
        )
        ...
        self.check_copy_consistency(
            "# Copied from MuseVdiffusers.schedulers.scheduling_ddpm.DDPMSchedulerOutput with DDPM->Test",
            "TestSchedulerOutput",
        ...
        self.check_copy_consistency(
            f"# Copied from MuseVdiffusers.schedulers.scheduling_ddpm.DDPMSchedulerOutput with DDPM->{long_class_name}",
