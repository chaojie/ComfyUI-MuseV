...
from MuseVdiffusers import AutoencoderKL, PaintByExamplePipeline, PNDMScheduler, UNet2DConditionModel
from MuseVdiffusers.pipelines.paint_by_example import PaintByExampleImageEncoder
