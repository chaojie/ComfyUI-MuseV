...
from MuseVdiffusers import DDIMPipeline, DDIMScheduler, UNet2DModel
from MuseVdiffusers.utils.testing_utils import enable_full_determinism, require_torch_gpu, slow, torch_device
