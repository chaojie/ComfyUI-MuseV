...
from MuseVdiffusers import Transformer2DModel, VQDiffusionPipeline, VQDiffusionScheduler, VQModel
from MuseVdiffusers.pipelines.vq_diffusion.pipeline_vq_diffusion import LearnedClassifierFreeSamplingEmbeddings
from MuseVdiffusers.utils.testing_utils import load_numpy, nightly, require_torch_gpu, torch_device
