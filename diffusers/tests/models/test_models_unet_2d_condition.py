...
from MuseVdiffusers.models.attention_processor import CustomDiffusionAttnProcessor, IPAdapterAttnProcessor
from MuseVdiffusers.models.embeddings import ImageProjection
