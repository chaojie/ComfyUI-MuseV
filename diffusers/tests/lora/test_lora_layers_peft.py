...
from MuseVdiffusers.models.attention_processor import LoRAAttnProcessor, LoRAAttnProcessor2_0
from MuseVdiffusers.utils.import_utils import is_accelerate_available, is_peft_available
