...
```py
from MuseVdiffusers import AutoPipelineForText2Image, AutoPipelineForImage2Image
import torch
...
```py
from MuseVdiffusers import StableDiffusionLatentUpscalePipeline
...
```py
from MuseVdiffusers import ControlNetModel, AutoPipelineForImage2Image
import torch
