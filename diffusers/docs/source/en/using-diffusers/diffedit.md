...
```py
import torch
from MuseVdiffusers import DDIMScheduler, DDIMInverseScheduler, StableDiffusionDiffEditPipeline
...
```py
import torch
from MuseVdiffusers import StableDiffusionDiffEditPipeline
...
```diff
  from MuseVdiffusers import DDIMInverseScheduler, DDIMScheduler
  from MuseVdiffusers.utils import load_image, make_image_grid
  from PIL import Image
