...
```py
from MuseVdiffusers import KandinskyPriorPipeline, KandinskyPipeline
import torch
...
```py
from MuseVdiffusers import KandinskyV22PriorPipeline, KandinskyV22Pipeline
import torch
...
```py
import torch
from MuseVdiffusers import KandinskyImg2ImgPipeline, KandinskyPriorPipeline
...
```py
import torch
from MuseVdiffusers import KandinskyV22Img2ImgPipeline, KandinskyPriorPipeline
...
```py
from MuseVdiffusers import KandinskyInpaintPipeline, KandinskyPriorPipeline
...
```py
from MuseVdiffusers import KandinskyV22InpaintPipeline, KandinskyV22PriorPipeline
from MuseVdiffusers.utils import load_image, make_image_grid
import torch
import numpy as np
from PIL import Image
...
import numpy as np
from PIL import Image
from MuseVdiffusers import AutoPipelineForInpainting
from MuseVdiffusers.utils import load_image, make_image_grid
...
```py
from MuseVdiffusers import KandinskyV22PriorPipeline, KandinskyV22ControlnetPipeline
...
from MuseVdiffusers import KandinskyV22PriorEmb2EmbPipeline, KandinskyV22ControlnetImg2ImgPipeline
from MuseVdiffusers.utils import load_image
from transformers import pipeline
...
```py
from MuseVdiffusers.models.attention_processor import AttnAddedKVProcessor2_0
