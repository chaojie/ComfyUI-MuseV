...
```python
import torch
from MuseVdiffusers import TextToVideoZeroPipeline
...
3. Run `StableDiffusionControlNetPipeline` with our custom attention processor
    ...
    from MuseVdiffusers.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero import CrossFrameAttnProcessor
