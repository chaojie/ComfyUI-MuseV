...
```py 
import torch
from MuseVdiffusers import StableDiffusionXLImg2ImgPipeline
...
```py 
import torch
from MuseVdiffusers import StableDiffusionXLInpaintPipeline
from MuseVdiffusers.utils import load_image
...
```py
from MuseVdiffusers import StableDiffusionXLPipeline, StableDiffusionXLImg2ImgPipeline
import torch
