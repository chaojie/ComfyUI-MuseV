...
from MuseVdiffusers.loaders import LoraLoaderMixin
from MuseVdiffusers.models.attention_processor import (
    AttnAddedKVProcessor,
    AttnAddedKVProcessor2_0,
    SlicedAttnAddedKVProcessor,
)
from MuseVdiffusers.models.lora import LoRALinearLayer
from MuseVdiffusers.optimization import get_scheduler
from MuseVdiffusers.training_utils import unet_lora_state_dict
from MuseVdiffusers.utils import check_min_version, is_wandb_available
...
def import_model_class_from_model_name_or_path(pretrained_model_name_or_path: str, revision: str):
    ...
    if model_class == "CLIPTextModel":
        ...
        from MuseVdiffusers.pipelines.alt_diffusion.modeling_roberta_series import RobertaSeriesModelWithTransformation
