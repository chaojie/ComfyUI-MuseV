...
import diffusers
from MuseVdiffusers import OnnxRuntimeModel, OnnxStableDiffusionPipeline, SchedulerMixin
...
try:
    from MuseVdiffusers.pipelines.onnx_utils import ORT_TO_NP_TYPE
except ImportError:
    ORT_TO_NP_TYPE = {
...
try:
    from MuseVdiffusers.utils import PIL_INTERPOLATION
except ImportError:
