...
from MuseVdiffusers.loaders import (
    FromSingleFileMixin,
    LoraLoaderMixin,
    StableDiffusionXLLoraLoaderMixin,
    TextualInversionLoaderMixin,
)
from MuseVdiffusers.models import (
    AutoencoderKL,
    ControlNetModel,
    MultiAdapter,
    T2IAdapter,
...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from MuseVdiffusers import DiffusionPipeline, T2IAdapter
...
class StableDiffusionXLControlNetAdapterInpaintPipeline(DiffusionPipeline, FromSingleFileMixin, LoraLoaderMixin):
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion_xl.pipeline_stable_diffusion_xl_img2img.StableDiffusionXLImg2ImgPipeline.get_timesteps
