...
from MuseVdiffusers import OnnxRuntimeModel, StableDiffusionImg2ImgPipeline, UniPCMultistepScheduler
...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from MuseVdiffusers import StableDiffusionControlNetImg2ImgPipeline, ControlNetModel, UniPCMultistepScheduler
...
class OnnxStableDiffusionControlNetImg2ImgPipeline(DiffusionPipeline):
    ...
    # Copied from MuseVdiffusers.pipelines.controlnet.pipeline_controlnet.StableDiffusionControlNetPipeline.prepare_image
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_img2img.StableDiffusionImg2ImgPipeline.get_timesteps
