...
from MuseVdiffusers.pipelines.unclip import UnCLIPTextProjModel
from MuseVdiffusers.utils import is_accelerate_available, logging
...
class UnCLIPImageInterpolationPipeline(DiffusionPipeline):
    ...
    # Copied from MuseVdiffusers.pipelines.unclip.pipeline_unclip_image_variation.UnCLIPImageVariationPipeline.__init__
    def __init__(
        self,
        decoder: UNet2DConditionModel,
        text_encoder: CLIPTextModelWithProjection,
    ...
    # Copied from MuseVdiffusers.pipelines.unclip.pipeline_unclip.UnCLIPPipeline.prepare_latents
    ...
    # Copied from MuseVdiffusers.pipelines.unclip.pipeline_unclip_image_variation.UnCLIPImageVariationPipeline._encode_prompt
    ...
    # Copied from MuseVdiffusers.pipelines.unclip.pipeline_unclip_image_variation.UnCLIPImageVariationPipeline._encode_image
    ...
    # Copied from MuseVdiffusers.pipelines.unclip.pipeline_unclip_image_variation.UnCLIPImageVariationPipeline.enable_sequential_cpu_offload
    ...
    @property
    # Copied from MuseVdiffusers.pipelines.unclip.pipeline_unclip.UnCLIPPipeline._execution_device
