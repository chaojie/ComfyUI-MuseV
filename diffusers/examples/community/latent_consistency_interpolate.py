...
from MuseVdiffusers.loaders import FromSingleFileMixin, LoraLoaderMixin, TextualInversionLoaderMixin
from MuseVdiffusers.models import AutoencoderKL, UNet2DConditionModel
...
from MuseVdiffusers.pipelines.stable_diffusion import StableDiffusionPipelineOutput, StableDiffusionSafetyChecker
from MuseVdiffusers.schedulers import LCMScheduler
...
class LatentConsistencyModelWalkPipeline(
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.encode_prompt
    def encode_prompt(
        self,
        prompt,
        device,
