...
from MuseVdiffusers.image_processor import PipelineImageInput, VaeImageProcessor
from MuseVdiffusers.loaders import FromSingleFileMixin, StableDiffusionXLLoraLoaderMixin, TextualInversionLoaderMixin
from MuseVdiffusers.models import AutoencoderKL, ControlNetModel, MultiAdapter, T2IAdapter, UNet2DConditionModel
from MuseVdiffusers.models.attention_processor import (
    AttnProcessor2_0,
    LoRAAttnProcessor2_0,
    LoRAXFormersAttnProcessor,
    XFormersAttnProcessor,
)
from MuseVdiffusers.models.lora import adjust_lora_scale_text_encoder
...
from MuseVdiffusers.pipelines.stable_diffusion_xl.pipeline_output import StableDiffusionXLPipelineOutput
from MuseVdiffusers.schedulers import KarrasDiffusionSchedulers
from MuseVdiffusers.utils import (
    PIL_INTERPOLATION,
    USE_PEFT_BACKEND,
    logging,
...
from MuseVdiffusers.utils.torch_utils import is_compiled_module, randn_tensor
...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from MuseVdiffusers import T2IAdapter, StableDiffusionXLAdapterPipeline, DDPMScheduler
...
# Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.rescale_noise_cfg
...
class StableDiffusionXLControlNetAdapterPipeline(
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.enable_vae_slicing
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.disable_vae_slicing
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.enable_vae_tiling
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.disable_vae_tiling
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion_xl.pipeline_stable_diffusion_xl.StableDiffusionXLPipeline.encode_prompt
    def encode_prompt(
        self,
        prompt: str,
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_extra_step_kwargs
    ...
    # Copied from MuseVdiffusers.pipelines.controlnet.pipeline_controlnet.StableDiffusionControlNetPipeline.check_image
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion_xl.pipeline_stable_diffusion_xl.StableDiffusionXLPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        prompt_2,
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_latents
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion_xl.pipeline_stable_diffusion_xl.StableDiffusionXLPipeline._get_add_time_ids
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_upscale.StableDiffusionUpscalePipeline.upcast_vae
    def upcast_vae(self):
    ...
    # Copied from MuseVdiffusers.pipelines.t2i_adapter.pipeline_stable_diffusion_adapter.StableDiffusionAdapterPipeline._default_height_width
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.enable_freeu
    ...
    # Copied from MuseVdiffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.disable_freeu
