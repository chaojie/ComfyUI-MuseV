...
try:
    from MuseVdiffusers.utils import randn_tensor
except:
    from MuseVdiffusers.utils.torch_utils import randn_tensor
from MuseVdiffusers.schedulers.scheduling_utils import (
...
class DPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Copied from MuseVdiffusers.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler._sigma_to_t
    ...
    # Copied from MuseVdiffusers.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler._convert_to_karras
