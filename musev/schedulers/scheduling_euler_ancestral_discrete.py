...
from MuseVdiffusers.utils import BaseOutput, logging
...
@dataclass
# Copied from MuseVdiffusers.schedulers.scheduling_ddpm.DDPMSchedulerOutput with DDPM->EulerAncestralDiscrete
...
class EulerAncestralDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Copied from MuseVdiffusers.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler.add_noise
    def add_noise(
        self,
