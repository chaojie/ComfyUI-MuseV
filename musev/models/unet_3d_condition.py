...
from MuseVdiffusers.configuration_utils import ConfigMixin, register_to_config
from MuseVdiffusers.loaders import UNet2DConditionLoadersMixin
from MuseVdiffusers.utils import BaseOutput

# from MuseVdiffusers.utils import logging
from MuseVdiffusers.models.embeddings import (
    TimestepEmbedding,
    Timesteps,
)
from MuseVdiffusers.models.modeling_utils import ModelMixin, load_state_dict
from MuseVdiffusers import __version__
...
from MuseVdiffusers.utils.import_utils import _safetensors_available
from MuseVdiffusers.models.unet_3d_condition import (
...
class UNet3DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    @property
    # Copied from MuseVdiffusers.models.unet_2d_condition.UNet2DConditionModel.attn_processors
    ...
    # Copied from MuseVdiffusers.models.unet_2d_condition.UNet2DConditionModel.set_attention_slice
    ...
    # Copied from MuseVdiffusers.models.unet_2d_condition.UNet2DConditionModel.set_attn_processor
    ...
    # Copied from MuseVdiffusers.models.unet_2d_condition.UNet2DConditionModel.set_default_attn_processor
    ...
    def from_pretrained_2d(
        ...
        if from_flax:
            ...
            # Convert the weights
            from MuseVdiffusers.models.modeling_pytorch_flax_utils import (
